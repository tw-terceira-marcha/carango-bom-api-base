...
import br.com.caelum.carangobom.data.DTO.ConstraintErrorDTO;
...
public interface IBaseController<Id, Entity, Repository extends JpaRepository<Entity, Id>,
    ...
    default ConstraintErrorDTO dataIntegrityViolationHandler(DataIntegrityViolationException e) {
        return new ConstraintErrorDTO();
    }
